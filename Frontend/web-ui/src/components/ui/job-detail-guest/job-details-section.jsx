  ...
  return (
    <>
      ...
      <article className="job-post">
        <header>
          <h2 className="section-title">3 Lý do để gia nhập công ty</h2>
        ...
        <section>
          <h2 className="section-title">Tại sao bạn sẽ yêu thích làm việc tại đây</h2>
          <ul className="section-content">
            {whyYouWillLoveWorkingHere.map((reason, index) => (
