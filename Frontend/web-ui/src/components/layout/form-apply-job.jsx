...
const job_detail = {
  ...
  jobLocation:
    "100 Xuan Thuy Street, Thao Dien Ward, Thu Duc City, Ho Chi Minh",
  jobType: "Hybrid",
  jobSkills: "Java,SQL",
  jobTopReasons:
  ...
  employerInfo: {
    ...
    workType: "hardcode",
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/d5daf5335140db7fa166023188d3eb55c01cfa497937c6436722a294b7d9b22d?apiKey=1293b2add2d347908b4e11760098fdbe&",
  },
};
const FormApplyJob = () => {
    ...
    <div className=" p-[30px] pb-[150px] bg-gray-200 bg-opacity-50">
      ...
      <div className=" max-w-[884px] ml-auto mr-auto relative">
        ...
        <div className="flex items-center justify-center relative h-[80px] ">
          <Link to="/" className="  flex text-white absolute left-0">
            {" "}
            <ChevronLeft /> Back
          </Link>
          <div className="">
            ...
            <div className=" relative ml-auto mr-auto max-w-[884px]">
              ...
              <div className=" rounded-lg bg-white p-[32px] shadow-lg">
                <h2 className="text-[22px] font-bold ">
                  Junior/Senior QC Engineer (Tester, English) at TPS Software
                </h2>
                ...
                <form className="mb-4  bg-white pb-3 pt-6">
                  ...
                  <div className="ml-6 mt-2">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      We accept .doc, .docx, .pdf files, no password protected,
                      up to 3MB
                    </p>
                  </div>
                </form>
