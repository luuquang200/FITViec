...
const EmployeeJobRecent = () => {
  ...
  //         if (docSnap.exists()) {
  //             // If the document exists, update it by appending the new job
  //              updateDoc(docRef, {
  //                 jobSaved: [],
  //             });
  //         } else {
      ...
      <div className=" min-h-screen bg-gray-200 w-full">
        ...
        <div className="bg-gray-200 w-full">
          <div className="mt-10 mr-32 ml-32 flex justify-between">
            <div><p className="text-2xl font-semibold">Recent Job</p></div>
            <div>
              <p>Sort by</p>
              <div></div>
            </div>
...
export default EmployeeJobRecent;
